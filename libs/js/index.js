...
var getListZona = function (comune) 
{
    ...
    var req = new Request.JSON({
        ...
        onSuccess: function(responseText) {
            ...
            if (optData.length == 0)
            {
                $('boxSearchHomeZona').setStyle("display", "none");
            }
            else
            {
                $('boxSearchHomeZona').setStyle("display", "block");
...
var getListTipo = function (categ) 
{
    ...
    var req = new Request.JSON({
        ...
        onSuccess: function(responseText) {
            ...
            $('boxSearchHomeTipo').setStyle("display", "block");
...
var activeSelect = function (tipo)
{
    ...
    if(tipo == 22)
    {
        $("boxSearchHomeAttCommerciale").setStyle("display", "block");
    ...
    {
        $("boxSearchHomeAttCommerciale").setStyle("display", "none");
