...
<div id="mainContainer" class="container clearfix">
    ...
    <form id="frmModImmobile" name="frmModImmobile">
        <section id="datiPrincipaliMod" class="column_1">
        ...
        <section id="ubicazioneMod" class="column_1">
            <h6>ubicazione:</h6>
            <ul>
                <li>
        ...
        <section id="descrizioneMod" class="column_1">
            <h6>descrizione:</h6>
            <textarea id="descrizione" name="descrizione"></textarea>
        </section>
        <section id="datiAccessoriMod" class="column_1">
            ...
            <button id="btnModImmobile" class="buttonBlue">Salva</button>
        </section>
    </form>
</div>