...
class Vetrina_Model extends Model
{
    ...
    public function getVetrina($data)
    {
        return $this->db->select("SELECT slideshow FROM tb_immobile WHERE id_immo = :id_immo", $data);
    }
    
    public function setVetrina($data)
    {
    ...
    public function getImageVetrina($data)
    {
        return $this->db->select("SELECT * FROM tb_image WHERE cod_immo = :cod_immo AND pos = 0", $data);
    }
    
    public function setImageVetrina($data)
    {
        $this->db->update("tb_image", array(
    ...
    function getLastID()
    {
        return $this->db->getLastID("tb_immobile", "id_immo");
    }
}
?>
